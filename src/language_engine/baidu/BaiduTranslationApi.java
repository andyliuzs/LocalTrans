    ...
    public static List<String> getTranslationJSON(@NotNull List<String> querys,
        ...
        if (querys.size() > 0) {
            ...
            for (String query : querys) {
                ...
                Logger.info("sourceLanguageCode"+sourceLanguageCode.getLanguageCode());
                Logger.info("targetLanguageCode"+targetLanguageCode.getLanguageCode());
                ...
                // 随机数
                String salt = "123456789";//String.valueOf(System.currentTimeMillis());
