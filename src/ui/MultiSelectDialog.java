...
//    }
    ...
    protected JComponent doCreateCenterPanel() {
        ...
        if (!data.isEmpty()) {
            ...
            final JCheckBox checkbox_selectAll = new JCheckBox("Select All");
            checkbox_selectAll.setMargin(new Insets(22, 300, 0, 0));
            panel.add(checkbox_selectAll, BorderLayout.NORTH);

            checkbox_selectAll.addItemListener(new ItemListener() {
                @Override
                public void itemStateChanged(ItemEvent e) {
                    if (e.getStateChange() == ItemEvent.SELECTED) {
                        selectedLanguages.addAll(data);
                        ...
                        selectedLanguages.removeAll(data);
